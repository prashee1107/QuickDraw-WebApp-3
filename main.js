...
if(error){
    ...
    document.getElementById("guessed_sketch").innerHTML = "Your Sketch : "+ results[0].label;
    document.getElementById("sketch_confidence").innerHTML = "Confidence : "+(results[0].confidence*100).toFixed(2);
